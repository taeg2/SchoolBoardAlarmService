package com.example.schoolalarmservice.crawling.service; // 본인의 테스트 패키지 경로
...
public class SmuCrawlerTest {

    @Test
    void 상명대_크롤링_테스트() {
        String targetUrl = "https://www.smu.ac.kr/kor/life/notice.do?mode=list&srCategoryId1=&srCampus=smu&srSearchKey=&srSearchVal=";
